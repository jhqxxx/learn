'''
Author: jhq
Date: 2025-03-12 13:29:13
LastEditTime: 2025-03-12 18:32:41
Description: 
'''
import torch
...
myModel = Llama(model_path=r"C:\jhq\huggingface_model\bartowski\Qwen2.5-14B-Instruct-1M-Q5_K_M.gguf",
# myModel = Llama(model_path=r"C:\jhq\huggingface_model\bartowski\Meta-Llama-3.1-8B-Instruct-GGUF\Meta-Llama-3.1-8B-Instruct-abliterated-Q8_0.gguf",
               verbose=False,
               n_gpu_layers=-1,
               n_ctx=8192,)

def generate_response(model: Llama, _messages: str) -> str:
...
class Agent:
    ...
    def _draft(self) -> Node:
        ...
        system_prompt = "You are an AI agent. You are good at writing python code and machine learning tasks."
    ...
    def _improve(self, parent_node: Node) -> Node:
        ...
        system_prompt = "You are an AI assistant.You are good at writing python code and machine learning tasks. Please provide suggestions for improvement based on the previous code"
    ...
    def _debug(self, parent_node: Node) -> Node:
        ...
        system_prompt = "You are an AI agent.You are good at writing python code and machine learning tasks,Please debug the code according to the error information"
